...
public final class FragmentForgotPasswordBinding implements ViewBinding {
  ...
  private FragmentForgotPasswordBinding(@NonNull LinearLayout rootView,
      @NonNull ImageButton btnBack, @NonNull Button btnSend, @NonNull TextInputEditText etEmail) {
  ...
  public static FragmentForgotPasswordBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentForgotPasswordBinding((LinearLayout) rootView, btnBack, btnSend, etEmail);
    }
